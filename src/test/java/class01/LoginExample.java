...
public class LoginExample {
    ...
    //pre-condition-->open the browser and navigate to the URL
    @BeforeMethod
    public void openBrowser() {//re-usability
        WebDriverManager.chromedriver().setup();//because we're using the pom.xml
        driver = new ChromeDriver();
        driver.get("http://hrm.syntaxtechs.net/humanresources/symfony/web/index.php/auth/login");
    }

    //post-condition-->quit the browser
    @AfterMethod
